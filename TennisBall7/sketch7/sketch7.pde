...
void setup() {
  fondo = loadImage("C:/Users/leandro/OneDrive/Desktop/TennisBall7/sketch7/imagen1.jpg");
...
void logica() {
  ...
  if (bolaY >= height) {
    ...
    if (arduinoPort != null) {
      arduinoPort.write('4');  // Se cambió de '3' a '4' para indicar reinicio
    }
  }
...
void cargarEstadisticas() {
  try {
    BufferedReader br = new BufferedReader(new FileReader("C:/Users/leandro/OneDrive/Desktop/TennisBall7/sketch7/estadisticas.txt"));
    String line;
...
void guardarEstadisticas() {
  ...
  try {
    PrintWriter writer = new PrintWriter(new FileWriter("C:/Users/leandro/OneDrive/Desktop/TennisBall7/sketch7/estadisticas.txt", true));
