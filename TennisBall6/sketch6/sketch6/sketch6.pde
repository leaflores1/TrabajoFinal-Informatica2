...
void setup() {
  ...
  fondo = loadImage("C:/Users/leandro/OneDrive/Desktop/TennisBall6/sketch6/imagen1.jpg");
...
void cargarEstadisticas() {
  try {
    BufferedReader br = new BufferedReader(new FileReader("C:/Users/leandro/OneDrive/Desktop/TennisBall6/sketch6/estadisticas.txt"));
    String line;
...
void guardarEstadisticas() {
  ...
  try {
    PrintWriter writer = new PrintWriter(new FileWriter("C:/Users/leandro/OneDrive/Desktop/TennisBall6/sketch6/estadisticas.txt", true));
